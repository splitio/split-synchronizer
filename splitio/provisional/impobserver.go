...
type ImpressionObserver interface {
	TestAndSet(featureName string, keyImpression *api.ImpressionDTO) (int64, error)
}
...
func (o *ImpressionObserverImpl) TestAndSet(featureName string, keyImpression *api.ImpressionDTO) (int64, error) {
...
func (o *ImpressionObserverNoOp) TestAndSet(featureName string, keyImpression *api.ImpressionDTO) (int64, error) {
	return 0, nil
}

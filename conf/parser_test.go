...
func TestLoadFromFileWithErrorOnSection(t *testing.T) {
	...
	if err.Error() != "\"redisError\" is not a valid section or property in configuration" {
...
func TestLoadFromFileWithErrorInsideSection(t *testing.T) {
	...
	if err.Error() != "\"hostError\" in section \"redis\" is not valid configuration" {
		t.Error("Wrong message error")
	}
}
...
func TestLoadFromFileWithErrorOnPropertyInt(t *testing.T) {
	...
	if err.Error() != "\"metricsError\" is not a valid section or property in configuration" {
		t.Error("Wrong message error")
	}
}
...
func TestLoadFromFileWithErrorOnPropertyString(t *testing.T) {
	...
	if err.Error() != "\"apiKeyError\" is not a valid section or property in configuration" {
		t.Error("Wrong message error")
	}
}
